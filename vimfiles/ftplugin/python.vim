...
froms = {
    ...
    'numpy': [
        ...
        'fromfile', 'fromiter', 'genfromtxt', 'hstack', 'index_exp', 'inner',
        'isinf', 'isnan', 'isreal', 'ix_', 'linspace', 'loadtxt', 'mean',
        'median', 'meshgrid', 'mgrid', 'nanargmax', 'nanargmin', 'nanmax',
        'nanmean', 'nanmedian', 'nanmin', 'nanpercentile', 'nanstd',
        'nansum', 'nanvar', 'ndarray', 'ndenumerate', 'ndfromtxt', 'ndim',
        'nditer', 'newaxis', 'ones', 'outer', 'pad', 'pi', 'r_', 'rad2deg',
        'radians', 'random', 'ravel', 'ravel_multi_index', 'reshape',
        'rot90', 's_', 'savez', 'savez_compressed', 'seterr', 'sin', 'sinc',
        'sinh', 'sqrt', 'squeeze', 'std', 'take', 'tan', 'tanh', 'tile',
        'trace', 'transpose', 'trapz', 'vectorize', 'vstack', 'where',
        'zeros'],
