...
froms = {
    ...
    'plottools': [
        ...
        'array_bunchify', 'axis_equal_3d', 'azip', 'cdfplot', 'cl', 'create',
        'cursor', 'd2r', 'dataobj', 'dcm2angle', 'dcm2quat', 'dict2obj', 'fg',
        'fig', 'figdo', 'fix_angles', 'index_all', 'map_dict', 'merge_dicts',
        'pad', 'picker', 'product_items', 'quat2dcm', 'r2d', 'resize',
        'savehtml', 'savepdf', 'savesvg', 'shift', 'styles', 'unique_legend',
        'unmask', 'varinfo'],
    'pprint': ['pprint'],
