...
froms = {
    ...
    'numpy': [
        ...
        'isinf', 'isnan', 'isreal', 'ix_', 'linspace', 'loadtxt', 'mat',
        'matrix', 'mean', 'median', 'meshgrid', 'mgrid', 'nan', 'nanargmax',
        'nanargmin', 'nanmax', 'nanmean', 'nanmedian', 'nanmin',
        'nanpercentile', 'nanstd', 'nansum', 'nanvar', 'ndarray', 'ndenumerate',
        'ndfromtxt', 'ndim', 'nditer', 'newaxis', 'ones', 'outer', 'pad', 'pi',
        'polyfit', 'polyval', 'r_', 'rad2deg', 'radians', 'random', 'ravel',
