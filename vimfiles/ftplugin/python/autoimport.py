...
froms = {
    ...
    'plottools': [
        'ArrayBunch', 'Conversion', 'angle2dcm', 'angle_difference',
        'array_bunchify', 'axis_equal_3d', 'azip', 'cdfplot', 'cl',
        'colored_line', 'create', 'cursor', 'd2r', 'dataobj', 'dcm2angle',
        'dcm2quat', 'dict2obj', 'fg', 'fig', 'figdo', 'fix_angles', 'flatten',
        'index_all', 'loadmat', 'map_dict', 'merge_dicts', 'minmax',
        'nanminmax', 'pad', 'picker', 'product_items', 'quat2dcm', 'r2d',
        'resize', 'savehtml', 'savemat', 'savepdf', 'savesvg', 'shift',
        'styles', 'unique_legend', 'unmask', 'where_first', 'where_last',
        'varinfo'],
    'pprint': ['pprint'],
