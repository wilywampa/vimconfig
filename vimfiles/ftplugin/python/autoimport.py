...
froms = {
    ...
    'plottools': [
        ...
        'dcm2quat', 'dict2obj', 'fg', 'fig', 'figdo', 'fix_angles', 'index_all',
        'loadmat', 'map_dict', 'merge_dicts', 'pad', 'picker', 'product_items',
        'quat2dcm', 'r2d', 'resize', 'savehtml', 'savemat', 'savepdf',
        'savesvg', 'shift', 'styles', 'unique_legend', 'unmask', 'where_first',
        'where_last', 'varinfo'],
    'pprint': ['pprint'],
